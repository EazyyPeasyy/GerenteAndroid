...
import com.example.gerenciadorfinanceiro.model.User
...
class RegisterActivity : AppCompatActivity(){
    ...
    private lateinit var mRegisterNumber: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRegisterNumber = findViewById(R.id.register_edit_text_number)
    ...
    private fun validate() {
        ...
        if (mRegisterNumber.text.isEmpty()){
            mRegisterNumber.error = "Este campo deve ser preenchido!"
            validate = false
        }
