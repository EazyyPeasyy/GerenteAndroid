...
class DespesasMovimentationsAdapter(val context: Context,val listMovimentation: ArrayList<Movimentation>):
RecyclerView.Adapter<DespesasMovimentationViewHolder>(){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DespesasMovimentationViewHolder {
        val view = layoutInflater.inflate(R.layout.item_recycleview,parent,false)

        var holder = DespesasMovimentationViewHolder(view)
    ...
    override fun onBindViewHolder(holder: DespesasMovimentationViewHolder, position: Int) {
...
class DespesasMovimentationViewHolder(view: View): RecyclerView.ViewHolder(view){
